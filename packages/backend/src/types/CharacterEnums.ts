...
export const MAIN_ARCHETYPES = [
  'DPS', 'Support', 'Sustain', 'Break DPS', 'Buffer', 'Debuff', 'Healer', 'Shielder'
] as const

export const COMMON_LABELS = [
  'DPS', 'Sub-DPS', 'Support', 'Sustain', 'Buffer', 'Debuff', 'Healer', 'Shielder',
  'Break DPS', 'Follow-up Attack', 'AoE', 'Single Target', 'Ultimate Based',
  'HP Scaling', 'ATK Scaling', 'Crit Support', 'Energy Support', 'F2P', 'Generalist'
] as const
