...
export function useCharacterGrouping(
  ...
  const charactersByRole = computed(() => {
    ...
    const sortedDpsCategories = Object.keys(dpsCategories)
      .sort()
      .reduce(
        (obj, key) => {
    ...
    const sortedSupportCategories = Object.keys(supportCategories)
      .sort()
      .reduce(
        (obj, key) => {
    ...
    const sortedSustainCategories = Object.keys(sustainCategories)
      .sort()
      .reduce(
        (obj, key) => {
