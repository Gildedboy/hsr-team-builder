                ...
                >
                  ...
                  <div>
                    ...
                    <div class="d-flex align-items-center gap-1">
                      ...
                      <span class="text-secondary" style="font-size: 10px;">{{ character.element }}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="mb-3">
              ...
              <div class="d-flex gap-2 justify-content-center">
                <button 
                  ...
                  :class="selectedRarities.includes(rarity) ? 'btn-outline-primary active' : 'btn-outline-secondary'"
            ...
            <div class="mb-3">
              ...
              <div class="d-flex flex-wrap gap-2 justify-content-center">
                <button 
                  ...
                  :class="selectedElements.includes(element) ? 'btn-outline-primary active border-primary' : 'btn-outline-secondary border-transparent'"
                >
            ...
            <div class="mb-3">
              ...
              <div class="d-flex flex-wrap gap-2 justify-content-center">
                <button 
                  ...
                  :title="path"
                  class="btn p-2 border-2"
                  :class="selectedPaths.includes(path) ? 'btn-outline-primary active border-primary' : 'btn-outline-secondary border-transparent'"
                >
            ...
            <div>
              ...
              <div class="d-flex flex-wrap gap-2 justify-content-center">
                <button 
                  ...
                  :class="selectedArchetypes.includes(archetype) ? 'btn-primary text-dark' : 'btn-outline-light'"
                >
                  {{ archetype }}
                </button>
              </div>
          ...
          <table class="table table-dark mb-0">
            <thead>
              <tr class="bg-gradient">
                <th class="text-primary text-center fw-bold border-end border-primary" style="width: 33.33%">DPS</th>
                <th class="text-primary text-center fw-bold border-end border-primary" style="width: 33.33%">Sub-DPS / Buffer / Debuffer</th>
                <th class="text-primary text-center fw-bold" style="width: 33.34%">Sustain</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="align-top p-3 border-end border-primary" style="background: rgba(0, 212, 255, 0.05);">
                  <div v-for="(chars, category) in charactersByRole.dps" :key="category" v-show="chars.length > 0" class="mb-4">
                    <h3 class="h5 text-primary mb-3 p-2 rounded border-start border-primary border-3" style="background: rgba(255, 255, 255, 0.1);">{{ category }} ({{ chars.length }})</h3>
                    <CharacterGrid 
                      :characters="chars"
                ...
                <td class="align-top p-3 border-end border-primary" style="background: rgba(155, 89, 182, 0.05);">
                  <div v-for="(chars, category) in charactersByRole.support" :key="category" v-show="chars.length > 0" class="mb-4">
                    <h3 class="h5 text-primary mb-3 p-2 rounded border-start border-primary border-3" style="background: rgba(255, 255, 255, 0.1);">{{ category }} ({{ chars.length }})</h3>
                    <CharacterGrid 
                      :characters="chars"
                      :selected-character="selectedCharacter"
                ...
                <td class="align-top p-3" style="background: rgba(46, 204, 113, 0.05);">
                  <div v-for="(chars, category) in charactersByRole.sustain" :key="category" v-show="chars.length > 0" class="mb-4">
                    <h3 class="h5 text-primary mb-3 p-2 rounded border-start border-primary border-3" style="background: rgba(255, 255, 255, 0.1);">{{ category }} ({{ chars.length }})</h3>
                    <CharacterGrid 
                      :characters="chars"
                      :selected-character="selectedCharacter"
      ...
      <div class="d-lg-none">
        <ul class="nav nav-tabs nav-fill" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active fw-bold custom-tab" data-bs-toggle="tab" data-bs-target="#dps-tab" type="button" role="tab">DPS</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link fw-bold custom-tab" data-bs-toggle="tab" data-bs-target="#support-tab" type="button" role="tab">Support</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link fw-bold custom-tab" data-bs-toggle="tab" data-bs-target="#sustain-tab" type="button" role="tab">Sustain</button>
          </li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane fade show active p-3" id="dps-tab" role="tabpanel" style="background: rgba(0, 212, 255, 0.05);">
            <div v-for="(chars, category) in charactersByRole.dps" :key="category" v-show="chars.length > 0" class="mb-4">
              <h3 class="h5 text-primary mb-3 p-2 rounded border-start border-primary border-3" style="background: rgba(255, 255, 255, 0.1);">{{ category }} ({{ chars.length }})</h3>
              <CharacterGrid 
                :characters="chars"
          ...
          <div class="tab-pane fade p-3" id="support-tab" role="tabpanel" style="background: rgba(155, 89, 182, 0.05);">
            <div v-for="(chars, category) in charactersByRole.support" :key="category" v-show="chars.length > 0" class="mb-4">
              <h3 class="h5 text-primary mb-3 p-2 rounded border-start border-primary border-3" style="background: rgba(255, 255, 255, 0.1);">{{ category }} ({{ chars.length }})</h3>
              <CharacterGrid 
                :characters="chars"
          ...
          <div class="tab-pane fade p-3" id="sustain-tab" role="tabpanel" style="background: rgba(46, 204, 113, 0.05);">
            <div v-for="(chars, category) in charactersByRole.sustain" :key="category" v-show="chars.length > 0" class="mb-4">
              <h3 class="h5 text-primary mb-3 p-2 rounded border-start border-primary border-3" style="background: rgba(255, 255, 255, 0.1);">{{ category }} ({{ chars.length }})</h3>
              <CharacterGrid 
                :characters="chars"
